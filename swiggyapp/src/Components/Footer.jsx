...
function Footer() {
    return (
        <div className='bg-[#282c3f] flex text-[8px] md:text-[16px]  text-white w-full  py-10 justify-center gap-10 md:gap-40 mx-auto mt-20 md:mt-10 flex-wrap items-center'>
            <div className='flex flex-col'>
                ...
                <p>@2023 Bundi <br></br>Technologies Pvt.ltd</p>
            </div>
            <div>
                <ul>
            ...
            <div>
                <ul>
                    <li className='font-bold text-[8px ] md:text-[16px]'>We deliver to:</li>
                    <li>Banglore</li>
                    <li>Gurugram</li>
                    <li>Haryana</li>
                    <li>Jaipur</li>
